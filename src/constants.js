...
export const colorBackground = '#fcfcfc';
export const colorError = '#A40000';
export const colorActive = '#0c2d22';
export const colorHover= schoolColorSecondary;
export const colorSelected = '#32473f';
